...
or_happens(pump_has_gone_into_free_flow,                120).   % Step 1b
    ?- happens(basal_over_infusion_alarm,               120).   % Step 2 && Post 1
...
?-  holdsIn(basal_delivery_enabled,                 60, 120),
    happens(basal_over_infusion_alarm,                  120),
 ...
 %?%holdsAt(kvo_delivery_enabled,                       120).
