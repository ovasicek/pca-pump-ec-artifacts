% EC10: Downstream Occlusion -- during clinician bolus
%
%   preconditions:
%       1 - normal operation
%
...
or_happens(downstream_occlusion_detected,           120).   % Step 1
    ?- happens(downstream_occlusion_alarm,          120).   % Step 2 && Post 1
...
?-  holdsAt(basal_delivery_enabled,                 70),
    ...
    happens(downstream_occlusion_alarm,             120),
