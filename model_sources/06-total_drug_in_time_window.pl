shortcut_total_drug_in_vtbi_window(TEndWindow, TotalAtTEndWindow, VtbiLimitTimePeriod, ResTotalDuringVtbiPeriod) :-
...
shortcut_total_drug_in_vtbi_window_assume_basal(TEndWindow, TotalBolusAtTEndWindow, VtbiLimitTimePeriod, ResTotalDuringVtbiPeriod) :-
